  ...
  return (
    <nav className="flex flex-col text-xs bg-gray-800 text-white items-start h-screen w-14">
      <ul className="w-3/4 mx-auto space-y-2">
        <li className="flex flex-col text-center rounded-md bg-slate-700 border-blue-950 border-2 mt-2" >
          <Link href="/">
        ...
        <li className="flex flex-col text-center rounded-md bg-slate-700 border-blue-950 border-2">
          <Link href="/projects">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 m-auto">
